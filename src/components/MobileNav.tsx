import { Home, ClipboardList, User, Heart, ShoppingBag } from "lucide-react";
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t md:hidden">
      <div className="flex justify-around py-3">
        ...
        <Link to="/orders" className={`flex flex-col items-center ${location.pathname === '/orders' ? 'text-sage-600' : 'text-gray-500'}`}>
